    ...
    <div className="min-h-screen bg-gray-950 text-gray-300">
      <div className="max-w-4xl mx-auto px-4 py-12 text-sm leading-relaxed">
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            If you discover a security vulnerability on OxSteed, we ask
            that you disclose it responsibly. Please report security issues
            to:
          </p>
          <p className="mb-3 font-semibold">
            <a href="mailto:security@oxsteed.com" className="text-orange-500 underline">security@oxsteed.com</a>
          </p>
          <p className="mb-3">
            Please include:
          </p>
          ...
          <p className="mb-3">
            ...
            resolve verified vulnerabilities as quickly as possible. We
            will not take legal action against researchers who follow
            responsible disclosure practices.
          </p>
          <p className="text-xs bg-yellow-900/30 border border-yellow-700/50 rounded-lg p-3 text-yellow-400">
            <strong>Do not</strong> access other users' accounts or data,
            perform denial-of-service attacks, or exploit vulnerabilities
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-5 space-y-2 mb-3">
            ...
            <li>Notify us immediately at <a href="mailto:security@oxsteed.com" className="text-orange-500 underline">security@oxsteed.com</a> if you suspect unauthorized access to your account;</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            In the event of a security incident that compromises personal
            data, OxSteed will:
          </p>
          <ul className="list-disc ml-5 space-y-2 mb-3">
        ...
        <p className="text-gray-500 text-xs mt-8 border-t border-gray-700 pt-4 mb-8">
          ...
          <a href="mailto:security@oxsteed.com" className="text-orange-500 underline">
            security@oxsteed.com
          </a>
        </p>
      </div>
    </div>
