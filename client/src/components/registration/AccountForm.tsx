    ...
    <form onSubmit={handleSubmit} noValidate>
      ...
      <div className="px-6 pb-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          {otpSent && !otpVerified && (
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-green-900/20 border border-green-700/30 text-xs text-green-400 font-medium">
              ...
              <button
                ...
                className="ml-auto text-xs font-semibold text-orange-500 underline hover:opacity-80 transition-opacity"
              >
                Resend
              </button>
            </div>
          ...
          {otpSent && !otpVerified && (
            <div className="flex flex-col gap-3">
              <label className="text-[11px] font-semibold tracking-wide uppercase text-gray-400">
                Verification code
              </label>
              <OTPInput
                value={otpDigits}
              ...
              />
              <p className="text-xs text-gray-500">Check your inbox and spam folder for the code.</p>
            </div>
          )}
